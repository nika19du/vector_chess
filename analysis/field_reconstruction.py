...
from chess_engine.models import PotentialField, PotentialSurface
...
def build_potential_surface(
    potential_field: PotentialField,
    resolution: int = DEFAULT_RESOLUTION,
    smoothing_sigma: float = DEFAULT_SMOOTHING_SIGMA,
) -> PotentialSurface:
    """
    Напасва bicubic сплайн повърхност през 8x8 потенциалната
    матрица.
    ...
    board_plot/potentian_plot/gradient_plot: x = колона (файл),
